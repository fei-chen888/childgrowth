...
var _localDataStores = __webpack_require__(21);

var _localDataStores2 = _interopRequireDefault(_localDataStores);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_vue2.default.prototype.$localData = new _localDataStores2.default();
_vue2.default.prototype.$extend = _common2.default;
  ...
  routes: [{
    ...
    component: function component(resolve) {
      __webpack_require__.e/* require.ensure */(1).then((function () {
        return resolve(__webpack_require__(22));
      }).bind(null, __webpack_require__)).catch(function () {
        _vue2.default.$toast('../page/index.vue');
      });
    }
  }, {
    name: 'child-add',
    ...
    component: function component(resolve) {
      __webpack_require__.e/* require.ensure */(0).then((function () {
        return resolve(__webpack_require__(23));
      }).bind(null, __webpack_require__)).catch(function () {
        _vue2.default.$toast('../page/index.vue');
      });
    },
...
var localDataStores = function () {
	function localDataStores() {
		_classCallCheck(this, localDataStores);
	}

	_createClass(localDataStores, [{
		key: 'deepCopy',
		value: function deepCopy(data) {
		...
		key: 'getItemArray',
		value: function getItemArray(key) {
			if (localStorage.getItem(key)) {
				try {
					return JSON.parse(localStorage.getItem(key));
				} catch (e) {
		...
		key: 'getItemValue',
		value: function getItemValue(key) {
...
exports.default = localDataStores;
